...
export function HRCommandCenter({
  ...
  async function loadHRData(showSkeleton = false) {
    ...
    setError("");
    try {
      const [employees, attendance, leaves, payroll, workload, performance, tasks, insights] = await Promise.all([
        apiRequest<EmployeeRow[]>("/hr/employees", accessToken),
      ...
      setData({ employees, attendance, leaves, payroll, workload, performance, tasks, insights });
