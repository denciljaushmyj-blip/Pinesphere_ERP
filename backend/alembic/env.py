...
from app.models import attendance, batch, branch, crm, finance, franchise, history, hr, lms, operations, settings as settings_model, token, trainer, user  # noqa: F401
