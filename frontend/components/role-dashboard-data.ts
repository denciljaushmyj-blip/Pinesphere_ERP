...
export const roleDashboardMocks: Record<RoleDashboardKey, RoleDashboardMock> = {
  super_admin: {
    ...
    metrics: [
      { key: "students", label: "Total Students", value: "0", helper: "All branches in scope", href: "/students", icon: "students", tone: "green" },
      { key: "branches", label: "Branches", value: "0", helper: "Organization branch network", href: "/branches", icon: "branches", tone: "blue" },
      { key: "fees", label: "Organization Revenue", value: "Rs 0", helper: "All collected payments", href: "/finance", icon: "wallet", tone: "orange" },
      { key: "security", label: "Security Checks", value: "Active", helper: "RBAC and session controls", href: "/security", icon: "security", tone: "purple" },
    ],
    donutCards: [],
    lineCards: [],
    funnels: [],
    ...
    lists: [
      {
        ...
        items: [
          { title: "Role dashboards isolated", detail: "Each role has a dedicated route and sidebar", meta: "Live", href: "/security", tone: "green" },
          { title: "Organization metrics connected", detail: "Super Admin endpoint uses organization scope", meta: "Live", href: "/reports", tone: "blue" },
        ],
      },
    ],
    summaryStats: [
  ...
  counsellor: {
    ...
    metrics: [
      ...
      { key: "conversion", label: "Conversion Rate", value: "24.3%", helper: "5.6% this month", href: "/reports", icon: "reports", tone: "orange" },
    ],
    donutCards: [
      {
        key: "lead-status",
    ...
    funnels: [
      {
        key: "lead-pipeline",
        title: "Lead Pipeline (This Month)",
        href: "/reports",
        linkLabel: "View pipeline report",
        data: [
          { label: "New Leads", value: 245, color: green },
          { label: "Contacted", value: 125, color: "#A9DDBD" },
          { label: "Qualified", value: 73, color: "#B8D8F6" },
          { label: "Proposal Sent", value: 28, color: "#CDB7F2" },
          { label: "Converted (Admissions)", value: 18, color: "#FFE0CC" },
        ],
      },
    ],
    lineCards: [
      {
        ...
        data: [
          { label: "1 May", current: 16, previous: 7 },
          { label: "8 May", current: 35, previous: 20 },
          { label: "15 May", current: 56, previous: 36 },
          { label: "22 May", current: 53, previous: 33 },
          { label: "31 May", current: 72, previous: 44 },
        ],
      },
    ],
    progressCards: [
      {
        ...
        data: [
          { label: "Full Stack Development", value: 86, detail: "8 Admissions" },
          { label: "Data Science", value: 58, detail: "5 Admissions" },
          { label: "Digital Marketing", value: 36, detail: "3 Admissions" },
        ],
      },
    ],
    lists: [
      {
        ...
        linkLabel: "View all",
        items: [
          { title: "Aarav Sharma", detail: "Full Stack Development", meta: "03 Jun 2026 - 10:00 AM", status: "Today", tone: "orange", href: "/crm", initials: "AS" },
          { title: "Neha Patel", detail: "Data Science", meta: "03 Jun 2026 - 11:30 AM", status: "Today", tone: "orange", href: "/crm", initials: "NP" },
          { title: "Rohan Kumar", detail: "Digital Marketing", meta: "04 Jun 2026 - 02:00 PM", status: "Tomorrow", tone: "blue", href: "/crm", initials: "RK" },
          { title: "Sneha Iyer", detail: "UI/UX Design", meta: "04 Jun 2026 - 03:30 PM", status: "Tomorrow", tone: "blue", href: "/crm", initials: "SI" },
          { title: "Vikram Desai", detail: "Cyber Security", meta: "05 Jun 2026 - 10:30 AM", status: "Upcoming", tone: "red", href: "/crm", initials: "VD" },
        ],
      },
      {
        key: "recent-leads",
    ...
    communicationStats: [
      { label: "Emails Sent", value: "126", icon: "messages", tone: "blue" },
      { label: "WhatsApp Msg", value: "78", icon: "communication", tone: "green" },
      { label: "Calls Done", value: "54", icon: "profile", tone: "green" },
      { label: "SMS Sent", value: "32", icon: "messages", tone: "purple" },
    ],
    summaryStats: [
  ...
  trainer: {
    ...
    metrics: [
      { key: "batches", label: "Total Batches", value: "6", helper: "2 Active • 4 Completed", href: "/trainer/batches", icon: "students", tone: "green" },
      { key: "students", label: "Total Students", value: "128", helper: "12.5% this month", href: "/trainer/students", icon: "academics", tone: "blue" },
      { key: "classes", label: "Classes Today", value: "3", helper: "Next: 11:30 AM (Data Structures)", href: "/trainer/calendar", icon: "calendar", tone: "orange" },
      { key: "attendance", label: "Attendance Today", value: "92.4%", helper: "4.3% vs yesterday", href: "/trainer/attendance", icon: "reports", tone: "purple" },
      { key: "tasks", label: "Pending Tasks", value: "5", helper: "View tasks", href: "/trainer/dashboard", icon: "tasks", tone: "green" },
    ],
    donutCards: [],
    funnels: [],
    lineCards: [
    ...
    lists: [
      {
        ...
        items: [
          { title: "Full Stack Development", detail: "Batch: FSD-2026-01", meta: "09:00 AM", status: "Completed", tone: "green", href: "/trainer/calendar" },
          { title: "Data Structures & Algorithms", detail: "Batch: DS-2026-01", meta: "11:30 AM", status: "Ongoing", tone: "blue", href: "/trainer/calendar" },
          { title: "UI/UX Design Principles", detail: "Batch: UX-2026-01", meta: "02:00 PM", status: "Scheduled", tone: "orange", href: "/trainer/calendar" },
          { title: "Python Programming", detail: "Batch: PY-2026-01", meta: "04:00 PM", status: "Scheduled", tone: "orange", href: "/trainer/calendar" },
        ],
      },
      {
        key: "assignments",
        ...
        linkLabel: "View all",
        items: [
          { title: "React Component Library", detail: "FSD-2026-01", meta: "Due: 05 Jun 2026", status: "12 Submitted", tone: "green", href: "/trainer/assignments" },
          { title: "DSA Problem Set - 5", detail: "DS-2026-01", meta: "Due: 06 Jun 2026", status: "8 Submitted", tone: "blue", href: "/trainer/assignments" },
          { title: "Python Functions", detail: "PY-2026-01", meta: "Due: 07 Jun 2026", status: "10 Submitted", tone: "orange", href: "/trainer/assignments" },
          { title: "UI Design Challenge", detail: "UX-2026-01", meta: "Due: 08 Jun 2026", status: "6 Submitted", tone: "blue", href: "/trainer/assignments" },
        ],
      },
      {
        key: "results",
        ...
        linkLabel: "View all",
        items: [
          { title: "DSA Quiz - 2", detail: "Avg Score: 78%", meta: "DS-2026-01", status: "Completed", tone: "purple", href: "/trainer/tests", initials: "DS" },
          { title: "HTML & CSS Test", detail: "Avg Score: 84%", meta: "FSD-2026-01", status: "Completed", tone: "purple", href: "/trainer/tests", initials: "F" },
          { title: "Python Basics Test", detail: "Avg Score: 88%", meta: "PY-2026-01", status: "Completed", tone: "purple", href: "/trainer/tests", initials: "PY" },
          { title: "UI Principles Test", detail: "Avg Score: 91%", meta: "UX-2026-01", status: "Completed", tone: "purple", href: "/trainer/tests", initials: "Y" },
        ],
      },
    ],
    tasks: {
      ...
      linkLabel: "View all",
      items: [
        { title: "Grade React Component Library", detail: "FSD-2026-01", due: "Due Today", href: "/trainer/assignments", tone: "red" },
        { title: "Review DSA Problem Set - 5", detail: "DS-2026-01", due: "Due Tomorrow", href: "/trainer/assignments", tone: "red" },
        { title: "Prepare Notes for Next Class", detail: "Python Programming", due: "Due 05 Jun", href: "/trainer/assignments", tone: "red" },
        { title: "Upload UI Design Resources", detail: "UX-2026-01", due: "Due 06 Jun", href: "/trainer/assignments", tone: "red" },
        { title: "Update Course Content", detail: "Full Stack Development", due: "Due 07 Jun", href: "/trainer/assignments", tone: "red" },
      ],
    },
    quickActions: [
      { label: "Mark Attendance", href: "/trainer/attendance", icon: "attendance" },
      { label: "Create Assignment", href: "/trainer/assignments", icon: "assignments" },
      { label: "Create Test", href: "/trainer/tests", icon: "tests" },
      { label: "Upload Material", href: "/trainer/lms", icon: "lms" },
      { label: "View Calendar", href: "/trainer/calendar", icon: "calendar" },
    ],
  },
  parent: {
    role: "parent",
